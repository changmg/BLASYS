...
, \res[5] , \res[6] , \res[7] , \res[8] );
  ...
  assign _09_ = \in2[6]  ^ \in1[6] ;
  assign _10_ = _08_ & ~(_09_);
  assign \res[6]  = _06_ & ~(_10_);
  assign _11_ = ~(\in1[5]  ^ \in2[5] );
  assign \res[5]  = _11_ ^ \res[0] ;
  assign _12_ = \in1[0]  & \in2[0] ;
  assign _13_ = ~(\in2[1]  ^ \in1[1] );
  assign _14_ = \in2[1]  ^ \in1[1] ;
  assign \res[1]  = _12_ ? _13_ : _14_;
  assign \res[2]  = 1'h0;
  assign \res[3]  = 1'h1;
  assign \res[4]  = 1'h0;
  assign \res[7]  = 1'h1;
