...
, \res[5] , \res[6] , \res[7] , \res[8] );
  ...
  assign \res[2]  = _13_ | ~(_09_);
  assign \res[5]  = \res[2]  ^ _00_;
  assign _14_ = ~(\in2[3]  ^ \in1[3] );
  assign _15_ = _02_ & ~(_08_);
  assign _16_ = _01_ & ~(_15_);
  assign _17_ = _16_ | _14_;
  assign _18_ = _01_ & ~(_12_);
  assign _19_ = _02_ & ~(_18_);
  assign _20_ = _14_ & ~(_19_);
  assign \res[3]  = _17_ & ~(_20_);
  assign _21_ = ~(\in1[1]  ^ \in2[1] );
  assign _22_ = _05_ & ~(_07_);
  assign \res[1]  = _04_ ? _22_ : _21_;
