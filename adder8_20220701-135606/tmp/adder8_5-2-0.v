...
, \res[5] , \res[6] , \res[7] , \res[8] );
  ...
  assign _01_ = ~(\in2[2]  ^ \in1[2] );
  assign _02_ = \in1[0]  & \in2[0] ;
  assign _03_ = \in1[1]  | \in2[1] ;
  assign _04_ = ~(_03_ & _02_);
  assign _05_ = \in1[1]  & \in2[1] ;
  assign _06_ = _04_ & ~(_05_);
  assign _07_ = _06_ | ~(_01_);
  assign _08_ = \in2[2]  ^ \in1[2] ;
  assign _09_ = ~(_05_ | _02_);
  assign _10_ = _03_ & ~(_09_);
  assign _11_ = _08_ & ~(_10_);
  assign \res[2]  = _11_ | ~(_07_);
  assign \res[5]  = \res[2]  ^ _00_;
  assign _12_ = ~(\in1[1]  ^ \in2[1] );
  assign _13_ = _03_ & ~(_05_);
  assign \res[1]  = _02_ ? _12_ : _13_;
