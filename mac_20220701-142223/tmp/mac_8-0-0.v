...
module mac(\a[0] , \a[1] , \a[2] , \a[3] , \b[0] , \b[1] , \b[2] , \b[3] , \c[0] , \c[1] , \c[2] , \c[3] , \r[0] , \r[1] , \r[2] , \r[3] , \r[4] , \r[5] , \r[6] , \r[7] );
  ...
  assign _09_ = ~(\a[0]  & \b[0] );
  assign _10_ = \c[0]  & ~(_09_);
  assign _11_ = _02_ ^ \c[1] ;
  ...
  assign _24_ = _06_ ^ _05_;
  assign _25_ = _23_ & ~(_24_);
  assign \r[5]  = _25_ | _07_;
  assign \r[7]  = ~(\b[3]  ^ \a[3] );
  assign \r[0]  = ~(_09_ ^ \c[0] );
  assign \r[1]  = ~(_14_ ^ _13_);
  assign \r[2]  = _20_ ^ _19_;
  assign \r[3]  = ~(_22_ ^ _08_);
  assign \r[4]  = ~(_24_ ^ _23_);
  assign \r[6]  = 1'h0;
endmodule
