...
module mac(\a[0] , \a[1] , \a[2] , \a[3] , \b[0] , \b[1] , \b[2] , \b[3] , \c[0] , \c[1] , \c[2] , \c[3] , \r[0] , \r[1] , \r[2] , \r[3] , \r[4] , \r[5] , \r[6] , \r[7] );
  ...
  assign _29_ = _11_ ^ _02_;
  assign _30_ = _29_ & _28_;
  assign \r[5]  = _30_ | _12_;
  assign \r[7]  = ~(\a[3]  ^ \b[2] );
  assign \r[0]  = ~(_14_ ^ \c[0] );
  assign \r[1]  = ~(_19_ ^ _18_);
  assign \r[2]  = _25_ ^ _24_;
  assign \r[3]  = _27_ ^ _13_;
  assign \r[4]  = _29_ ^ _28_;
  assign \r[6]  = 1'h0;
endmodule
