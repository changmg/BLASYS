...
module mac(\a[0] , \a[1] , \a[2] , \a[3] , \b[0] , \b[1] , \b[2] , \b[3] , \c[0] , \c[1] , \c[2] , \c[3] , \r[0] , \r[1] , \r[2] , \r[3] , \r[4] , \r[5] , \r[6] , \r[7] );
  ...
  assign _17_ = \b[2]  & \a[1] ;
  assign _18_ = _12_ | _10_;
  assign _19_ = _13_ & ~(_09_);
  assign _20_ = _18_ & ~(_19_);
  assign _21_ = _20_ ^ _17_;
  assign _22_ = ~(_14_ & _08_);
  assign _23_ = _16_ & _15_;
  assign _24_ = _22_ & ~(_23_);
  assign \r[3]  = _24_ ^ _21_;
  assign _25_ = _17_ & ~(_20_);
  assign _26_ = ~(_24_ | _21_);
  assign _27_ = _26_ ^ _25_;
  assign _28_ = ~_25_;
  assign _29_ = _26_ ^ _28_;
  assign \r[4]  = _12_ ? _29_ : _27_;
  assign _30_ = _26_ | _25_;
  assign _31_ = _26_ & ~(_28_);
  assign \r[5]  = _12_ ? _30_ : _31_;
  assign \r[6]  = 1'h0;
endmodule
