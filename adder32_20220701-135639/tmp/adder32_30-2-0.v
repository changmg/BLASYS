...
, \res[20] , \res[21] , \res[22] , \res[23] , \res[24] , \res[25] , \res[26] , \res[27] , \res[28] , \res[29] , \res[30] , \res[31] , \res[32] );
  ...
  assign \res[24]  = ~(_01_ ^ _00_);
  assign _02_ = \in1[28]  ^ \in2[28] ;
  assign \res[32]  = _02_ ^ \res[24] ;
  assign \res[28]  = ~\res[32] ;
  assign _03_ = ~(\in2[30]  ^ \in1[30] );
  assign _04_ = ~\in1[28] ;
  assign _05_ = \res[24]  & ~(\in2[28] );
  assign _06_ = _05_ | _04_;
  assign _07_ = \in2[28]  & ~(\res[24] );
  assign _08_ = _06_ & ~(_07_);
  assign _09_ = ~(\in1[29]  | \in2[29] );
  assign _10_ = _09_ | _08_;
  assign _11_ = \in1[29]  & \in2[29] ;
  assign _12_ = _10_ & ~(_11_);
  assign _13_ = _12_ | _03_;
  assign _14_ = _04_ & ~(_07_);
  assign _15_ = _14_ | _05_;
  assign _16_ = _15_ & ~(_11_);
  assign _17_ = \in2[30]  ^ \in1[30] ;
  assign _18_ = _16_ & ~(_17_);
  assign _19_ = _13_ & ~(_18_);
  assign _20_ = _09_ & ~(_17_);
  assign \res[30]  = _19_ & ~(_20_);
  assign _21_ = ~(\in1[29]  ^ \in2[29] );
  assign _22_ = _21_ | _08_;
  assign _23_ = ~(_11_ | _09_);
  assign _24_ = _15_ & ~(_23_);
  assign \res[29]  = _22_ & ~(_24_);
  assign \res[17]  = \in2[17]  ^ \in1[17] ;
  assign _25_ = ~(\in1[15]  ^ \in2[15] );
  assign \res[15]  = _25_ ^ \res[12] ;
  assign \res[7]  = ~(\in1[7]  ^ \in2[7] );
  assign _26_ = \in1[3]  ^ \in2[3] ;
  assign _27_ = \in1[0]  & \in2[0] ;
  assign _28_ = \in2[1]  ^ \in1[1] ;
  assign _29_ = ~(\in2[1]  ^ \in1[1] );
  assign _30_ = _27_ ? _28_ : _29_;
  assign \res[3]  = _30_ ^ _26_;
  assign \res[20]  = ~_01_;
  assign \res[1]  = ~_30_;
