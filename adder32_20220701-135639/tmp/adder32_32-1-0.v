...
, \res[20] , \res[21] , \res[22] , \res[23] , \res[24] , \res[25] , \res[26] , \res[27] , \res[28] , \res[29] , \res[30] , \res[31] , \res[32] );
  ...
  assign _02_ = ~(\in2[17]  ^ \in1[17] );
  assign _03_ = \in1[16]  & \in2[16] ;
  assign _04_ = \in2[17]  ^ \in1[17] ;
  assign \res[17]  = _03_ ? _02_ : _04_;
  assign _05_ = ~(\in1[15]  ^ \in2[15] );
  assign \res[15]  = _05_ ^ \res[12] ;
  assign \res[7]  = ~(\in1[7]  ^ \in2[7] );
  assign _06_ = ~(\in1[3]  ^ \in2[3] );
  assign \res[0]  = \in1[0]  ^ \in2[0] ;
  assign \res[3]  = \res[0]  ^ _06_;
  assign \res[10]  = 1'h0;
  assign \res[11]  = 1'h1;
  assign \res[13]  = 1'h1;
  assign \res[14]  = 1'h0;
