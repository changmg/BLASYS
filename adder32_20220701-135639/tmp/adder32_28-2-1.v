...
, \res[20] , \res[21] , \res[22] , \res[23] , \res[24] , \res[25] , \res[26] , \res[27] , \res[28] , \res[29] , \res[30] , \res[31] , \res[32] );
  ...
  assign _21_ = ~(\in1[15]  ^ \in2[15] );
  assign \res[15]  = _21_ ^ \res[12] ;
  assign \res[7]  = ~(\in1[7]  ^ \in2[7] );
  assign _22_ = \in1[3]  ^ \in2[3] ;
  assign _23_ = \in1[0]  & \in2[0] ;
  assign _24_ = \in2[1]  ^ \in1[1] ;
  assign _25_ = ~(\in2[1]  ^ \in1[1] );
  assign _26_ = _23_ ? _24_ : _25_;
  assign \res[3]  = _26_ ^ _22_;
  assign \res[20]  = ~_01_;
