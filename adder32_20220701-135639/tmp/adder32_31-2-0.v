...
, \res[20] , \res[21] , \res[22] , \res[23] , \res[24] , \res[25] , \res[26] , \res[27] , \res[28] , \res[29] , \res[30] , \res[31] , \res[32] );
  ...
  assign _14_ = ~(\in1[15]  ^ \in2[15] );
  assign \res[15]  = _14_ ^ \res[12] ;
  assign \res[7]  = ~(\in1[7]  ^ \in2[7] );
  assign _15_ = \in1[3]  ^ \in2[3] ;
  assign _16_ = \in1[0]  & \in2[0] ;
  assign _17_ = \in2[1]  ^ \in1[1] ;
  assign _18_ = ~(\in2[1]  ^ \in1[1] );
  assign _19_ = _16_ ? _17_ : _18_;
  assign \res[3]  = _19_ ^ _15_;
  assign \res[20]  = ~_01_;
  assign \res[1]  = ~_19_;
