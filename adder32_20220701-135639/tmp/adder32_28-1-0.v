...
, \res[20] , \res[21] , \res[22] , \res[23] , \res[24] , \res[25] , \res[26] , \res[27] , \res[28] , \res[29] , \res[30] , \res[31] , \res[32] );
  ...
  assign _010_ = ~(\in1[24]  ^ \in2[24] );
  assign _011_ = \in2[20]  ^ \in1[20] ;
  assign \res[24]  = ~(_011_ ^ _010_);
  assign \res[20]  = ~_011_;
  assign _012_ = \in1[28]  ^ \in2[28] ;
  assign \res[32]  = _012_ ^ \res[24] ;
  assign \res[28]  = ~\res[32] ;
  assign _013_ = ~(\in2[31]  ^ \in1[31] );
  assign _014_ = ~\in1[28] ;
  assign _015_ = \res[24]  & ~(\in2[28] );
  assign _016_ = _015_ | _014_;
  assign _017_ = \in2[28]  & ~(\res[24] );
