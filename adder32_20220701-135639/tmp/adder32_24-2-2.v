...
, \res[20] , \res[21] , \res[22] , \res[23] , \res[24] , \res[25] , \res[26] , \res[27] , \res[28] , \res[29] , \res[30] , \res[31] , \res[32] );
  ...
  assign _032_ = ~(\in1[26]  | \in2[26] );
  assign _033_ = ~(_032_ | _031_);
  assign _034_ = ~\in1[24] ;
  assign \res[20]  = ~(\in1[20]  ^ \in2[20] );
  assign _035_ = \res[20]  & ~(\in2[24] );
  assign _036_ = _035_ | _034_;
  assign _037_ = \in2[24]  & ~(\res[20] );
  ...
  assign _067_ = _066_ & ~(_054_);
  assign \res[32]  = _067_ | _053_;
  assign _068_ = ~(_054_ | _053_);
  assign \res[31]  = _068_ ^ _066_;
  assign _069_ = ~(_056_ | _055_);
  assign \res[30]  = _069_ ^ _064_;
  assign _070_ = _057_ | ~(_058_);
  assign \res[29]  = _070_ ^ _062_;
  assign _000_ = ~(\in2[27]  ^ \in1[27] );
  assign _001_ = _038_ | _032_;
  assign _002_ = _040_ & ~(_001_);
  assign _003_ = ~(_042_ | _032_);
  ...
  assign _009_ = _008_ | _031_;
  assign _010_ = _042_ & ~(_009_);
  assign _011_ = _006_ & ~(_010_);
  assign _012_ = _039_ & ~(_031_);
  assign _013_ = _012_ | _032_;
  assign _014_ = _013_ & ~(_007_);
  assign \res[27]  = _011_ & ~(_014_);
  assign _015_ = ~(\in1[25]  ^ \in2[25] );
  assign _016_ = _015_ | _038_;
  assign _017_ = _042_ & ~(_039_);
  assign _018_ = ~(_017_ | _046_);
  assign \res[25]  = _016_ & ~(_018_);
  assign _019_ = ~(\in2[21]  ^ \in1[21] );
  assign _020_ = ~(\in1[20]  | \in2[20] );
  assign _021_ = _020_ | _019_;
  assign _022_ = \in2[21]  ^ \in1[21] ;
  assign _023_ = _020_ & ~(_022_);
  assign \res[21]  = _021_ & ~(_023_);
  assign \res[17]  = \in2[17]  ^ \in1[17] ;
  assign _024_ = ~(\in1[15]  ^ \in2[15] );
  assign \res[15]  = _024_ ^ \res[12] ;
  assign \res[7]  = ~(\in1[7]  ^ \in2[7] );
  assign _025_ = \in1[3]  ^ \in2[3] ;
  assign _026_ = \in1[0]  & \in2[0] ;
  assign _027_ = \in2[1]  ^ \in1[1] ;
  assign _028_ = ~(\in2[1]  ^ \in1[1] );
  assign _029_ = _026_ ? _027_ : _028_;
  assign \res[3]  = _029_ ^ _025_;
  assign \res[28]  = _060_ ^ _052_;
  assign _030_ = ~(\in1[24]  ^ \in2[24] );
  assign \res[24]  = _030_ ^ \res[20] ;
  assign \res[1]  = ~_029_;
