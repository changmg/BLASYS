...
, \res[20] , \res[21] , \res[22] , \res[23] , \res[24] , \res[25] , \res[26] , \res[27] , \res[28] , \res[29] , \res[30] , \res[31] , \res[32] );
  ...
  assign _067_ = _066_ | _039_;
  assign _068_ = _067_ & ~(_038_);
  assign _069_ = _068_ | _037_;
  assign _070_ = _069_ & ~(_036_);
  assign \res[32]  = _070_ | _035_;
  assign _071_ = ~(_036_ | _035_);
  assign \res[31]  = _071_ ^ _069_;
  assign _072_ = ~(_038_ | _037_);
  assign \res[30]  = _072_ ^ _067_;
  assign _073_ = _039_ | ~(_040_);
  ...
  assign _080_ = ~(_025_ | _109_);
  assign _081_ = _108_ & ~(_080_);
  assign _082_ = _081_ | _079_;
  assign _083_ = \in2[23]  ^ \in1[23] ;
  assign _084_ = _083_ | ~(_029_);
  assign _085_ = _111_ & ~(_083_);
  assign _086_ = _084_ & ~(_085_);
  assign _087_ = _108_ & ~(_086_);
  assign _088_ = _082_ & ~(_087_);
  assign _089_ = _109_ & ~(_083_);
  assign \res[23]  = _088_ & ~(_089_);
  assign _090_ = ~(\in1[21]  ^ \in2[21] );
  assign _091_ = _090_ | _022_;
  assign _092_ = ~(_024_ | _111_);
  assign _093_ = ~(_092_ | _028_);
  assign \res[21]  = _091_ & ~(_093_);
  assign _094_ = _015_ & _000_;
  assign _095_ = ~(_094_ | _001_);
  assign _096_ = _095_ & _004_;
  assign _097_ = _011_ & ~(_096_);
  assign \res[19]  = _097_ ^ _007_;
  assign _098_ = _000_ & ~(_014_);
  assign \res[17]  = _098_ ^ _003_;
  assign _099_ = _114_ & ~(_130_);
  assign \res[15]  = _099_ ^ _129_;
  assign _100_ = _124_ | _117_;
  assign _101_ = _122_ & ~(_123_);
  assign \res[13]  = _101_ ^ _100_;
  assign \res[7]  = ~(\in1[7]  ^ \in2[7] );
  assign _102_ = \in1[3]  ^ \in2[3] ;
  assign _103_ = ~(\in1[0]  ^ \in2[0] );
  assign \res[3]  = _103_ ^ _102_;
  assign _104_ = _021_ | _112_;
  assign _105_ = \in1[20]  ^ \in2[20] ;
  assign \res[20]  = _019_ ? _105_ : _104_;
  assign \res[18]  = _095_ ^ _004_;
  assign _106_ = _129_ | ~(_114_);
  assign _107_ = _106_ & ~(_130_);
  assign \res[16]  = _113_ ? _132_ : _107_;
  assign \res[28]  = _063_ ^ _062_;
  assign \res[24]  = ~(_042_ ^ _034_);
  assign \res[26]  = _075_ ^ _047_;
  assign \res[0]  = ~_103_;
  assign \res[12]  = _121_ ^ \res[8] ;
  assign \res[14]  = ~(_127_ ^ _116_);
  assign _108_ = ~(\in1[22]  & \in2[22] );
  assign _109_ = ~(\in1[22]  | \in2[22] );
  assign _110_ = _108_ & ~(_109_);
  assign _111_ = ~(\in1[21]  | \in2[21] );
  assign _112_ = ~(\in1[20]  | \in2[20] );
  ...
  assign \res[8]  = _119_ ? _118_ : _120_;
  assign _121_ = ~(\in2[12]  ^ \in1[12] );
  assign _122_ = _121_ | \res[8] ;
