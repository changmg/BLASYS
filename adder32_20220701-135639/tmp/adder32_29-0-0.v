...
, \res[20] , \res[21] , \res[22] , \res[23] , \res[24] , \res[25] , \res[26] , \res[27] , \res[28] , \res[29] , \res[30] , \res[31] , \res[32] );
  ...
  assign _001_ = _055_ & ~(_000_);
  assign \res[25]  = _053_ & ~(_001_);
  assign \res[17]  = \in2[17]  ^ \in1[17] ;
  assign _002_ = ~(\in1[15]  ^ \in2[15] );
  assign \res[15]  = _002_ ^ \res[12] ;
  assign \res[7]  = ~(\in1[7]  ^ \in2[7] );
  assign _003_ = \in1[3]  ^ \in2[3] ;
  assign _004_ = ~(\in1[0]  ^ \in2[0] );
  assign \res[3]  = _004_ ^ _003_;
  assign \res[0]  = ~_004_;
  assign \res[10]  = 1'h0;
  assign \res[11]  = 1'h1;
  assign \res[13]  = 1'h1;
