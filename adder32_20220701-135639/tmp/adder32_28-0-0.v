...
, \res[20] , \res[21] , \res[22] , \res[23] , \res[24] , \res[25] , \res[26] , \res[27] , \res[28] , \res[29] , \res[30] , \res[31] , \res[32] );
  ...
  assign _018_ = \res[20]  & ~(\in2[24] );
  assign _019_ = _018_ | _017_;
  assign _020_ = \in2[24]  & ~(\res[20] );
  assign _021_ = _019_ & ~(_020_);
  assign _022_ = ~(\in1[25]  | \in2[25] );
  assign _023_ = ~(_022_ | _021_);
  assign _024_ = ~(\in1[25]  & \in2[25] );
  assign _025_ = _024_ & ~(_023_);
  assign _026_ = _025_ | _016_;
  assign _027_ = _017_ & ~(_020_);
  ...
  assign \res[31]  = _057_ & ~(_060_);
  assign _061_ = ~(\in1[30]  ^ \in2[30] );
  assign _062_ = ~(_043_ | _040_);
  assign _063_ = _045_ & ~(_062_);
  assign _064_ = _063_ | _061_;
  assign _065_ = _045_ & ~(_052_);
  assign _000_ = _041_ & ~(_048_);
  assign _001_ = _065_ & ~(_000_);
  assign _002_ = _064_ & ~(_001_);
  assign _003_ = _043_ & ~(_000_);
  assign \res[30]  = _002_ & ~(_003_);
  assign _004_ = ~(\in1[29]  ^ \in2[29] );
  assign _005_ = _004_ | _040_;
  assign _006_ = _045_ & ~(_043_);
  assign _007_ = ~(_006_ | _052_);
  assign \res[29]  = _005_ & ~(_007_);
  assign _008_ = ~(\in1[25]  ^ \in2[25] );
  assign _009_ = _008_ | _021_;
  assign _010_ = _022_ | ~(_024_);
  assign _011_ = _010_ & ~(_028_);
  assign \res[25]  = _009_ & ~(_011_);
  assign \res[17]  = \in2[17]  ^ \in1[17] ;
  assign _012_ = ~(\in1[15]  ^ \in2[15] );
  assign \res[15]  = _012_ ^ \res[12] ;
  assign \res[7]  = ~(\in1[7]  ^ \in2[7] );
  assign _013_ = \in1[3]  ^ \in2[3] ;
  assign _014_ = ~(\in1[0]  ^ \in2[0] );
  assign \res[3]  = _014_ ^ _013_;
  assign _015_ = ~(\in1[24]  ^ \in2[24] );
  assign \res[24]  = _015_ ^ \res[20] ;
  assign \res[0]  = ~_014_;
  assign \res[10]  = 1'h0;
  assign \res[11]  = 1'h1;
  assign \res[13]  = 1'h1;
