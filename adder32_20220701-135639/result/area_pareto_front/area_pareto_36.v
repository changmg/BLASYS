...
, \res[20] , \res[21] , \res[22] , \res[23] , \res[24] , \res[25] , \res[26] , \res[27] , \res[28] , \res[29] , \res[30] , \res[31] , \res[32] );
  ...
  assign _005_ = \res[20]  & ~(\in2[24] );
  assign _006_ = _005_ | _004_;
  assign _007_ = \in2[24]  & ~(\res[20] );
  ...
  assign _002_ = ~(\in1[24]  ^ \in2[24] );
  assign \res[24]  = _002_ ^ \res[20] ;
  assign \res[0]  = ~_001_;
  assign \res[10]  = 1'h0;
  assign \res[11]  = 1'h1;
  assign \res[13]  = 1'h1;
