...
, \res[10] , \res[11] , \res[12] , \res[13] , \res[14] , \res[15] , \res[16] );
  ...
  assign _23_ = \in1[3]  ^ \in2[3] ;
  assign _24_ = ~(\in1[0]  ^ \in2[0] );
  assign \res[3]  = _24_ ^ _23_;
  assign _25_ = \in1[0]  & \in2[0] ;
  assign _26_ = ~(\in2[1]  ^ \in1[1] );
  assign _27_ = \in2[1]  ^ \in1[1] ;
  assign \res[1]  = _25_ ? _26_ : _27_;
  assign \res[0]  = ~_24_;
  assign \res[10]  = 1'h0;
  assign \res[11]  = 1'h1;
  assign \res[12]  = 1'h0;
