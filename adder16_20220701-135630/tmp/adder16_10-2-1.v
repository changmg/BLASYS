...
, \res[10] , \res[11] , \res[12] , \res[13] , \res[14] , \res[15] , \res[16] );
  ...
  assign _15_ = ~(\in2[15]  | \in1[15] );
  assign _16_ = \in2[14]  & \in1[14] ;
  assign _17_ = ~(\in2[14]  | \in1[14] );
  assign _18_ = \in1[13]  & \in2[13] ;
  assign _19_ = ~(\in1[13]  | \in2[13] );
  assign _20_ = _13_ & ~(_19_);
  assign _21_ = _20_ | _18_;
  assign _22_ = _21_ & ~(_17_);
  assign _23_ = _22_ | _16_;
  assign _24_ = _23_ & ~(_15_);
  assign \res[16]  = _24_ | _14_;
  assign _25_ = ~(_15_ | _14_);
  assign \res[15]  = _25_ ^ _23_;
  assign _26_ = ~(_17_ | _16_);
  assign \res[14]  = _26_ ^ _21_;
  assign _27_ = ~(_19_ | _18_);
  assign \res[13]  = _27_ ^ _13_;
  assign _28_ = ~(\in2[9]  ^ \in1[9] );
  assign _29_ = ~\in1[8] ;
  assign _30_ = ~\in2[8] ;
  assign _31_ = _30_ & ~(_12_);
  assign _32_ = _31_ | _29_;
  assign _33_ = _12_ & ~(_30_);
  assign _34_ = _32_ & ~(_33_);
  assign _35_ = _34_ | _28_;
  assign _36_ = _29_ & ~(_33_);
  assign _37_ = _36_ | _31_;
  assign _38_ = \in2[9]  ^ \in1[9] ;
  assign _39_ = _37_ & ~(_38_);
  assign \res[9]  = _35_ & ~(_39_);
  assign _40_ = ~(\in1[3]  ^ \in2[3] );
  assign \res[3]  = _40_ ^ \res[0] ;
  assign \res[10]  = 1'h0;
  assign \res[11]  = 1'h1;
  assign \res[12]  = 1'h0;
  assign \res[1]  = 1'h1;
