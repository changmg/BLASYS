...
, \res[20] , \res[21] , \res[22] , \res[23] , \res[24] , \res[25] , \res[26] , \res[27] , \res[28] , \res[29] , \res[30] , \res[31] , \res[32] );
  ...
  assign _099_ = ~(_131_ | _130_);
  assign \res[15]  = _099_ ^ _123_;
  assign _100_ = ~(\in1[13]  ^ \in2[13] );
  assign _101_ = ~(_115_ | _113_);
  assign \res[13]  = _112_ ? _101_ : _100_;
  assign \res[7]  = ~(\in1[7]  ^ \in2[7] );
  assign _102_ = \in1[3]  ^ \in2[3] ;
  assign _103_ = \in1[0]  & \in2[0] ;
  assign _104_ = \in2[1]  ^ \in1[1] ;
  assign _105_ = ~(\in2[1]  ^ \in1[1] );
  assign _106_ = _103_ ? _104_ : _105_;
  assign \res[3]  = _106_ ^ _102_;
  assign _107_ = _021_ | _128_;
  assign _108_ = \in1[20]  ^ \in2[20] ;
  assign \res[20]  = _019_ ? _108_ : _107_;
  assign \res[18]  = _095_ ^ _004_;
  assign _109_ = ~(_130_ | _123_);
  assign _110_ = _132_ & ~(_109_);
  assign \res[16]  = _129_ ? _134_ : _110_;
  ...
  assign _112_ = ~(\in1[12]  | \in2[12] );
  assign _113_ = ~(\in1[13]  | \in2[13] );
  ...
  assign \res[14]  = ~_123_;
  assign _124_ = ~(\in1[22]  & \in2[22] );
  assign _125_ = ~(\in1[22]  | \in2[22] );
  assign _126_ = _124_ & ~(_125_);
  assign _127_ = ~(\in1[21]  | \in2[21] );
  assign _128_ = ~(\in1[20]  | \in2[20] );
  assign _129_ = \in2[16]  ^ \in1[16] ;
  assign _130_ = \in2[15]  & \in1[15] ;
  assign _131_ = ~(\in2[15]  | \in1[15] );
  assign _132_ = ~_131_;
  assign _133_ = ~(_132_ & _123_);
  assign _134_ = _133_ & ~(_130_);
  assign _000_ = _134_ | ~(_129_);
