...
, \res[20] , \res[21] , \res[22] , \res[23] , \res[24] , \res[25] , \res[26] , \res[27] , \res[28] , \res[29] , \res[30] , \res[31] , \res[32] );
  ...
  assign _00_ = ~(\in1[24]  ^ \in2[24] );
  assign _01_ = \in2[20]  ^ \in1[20] ;
  assign _02_ = _01_ ^ _00_;
  assign \res[24]  = ~_02_;
  assign \res[20]  = ~_01_;
  assign _03_ = \in2[31]  & \in1[31] ;
  assign _04_ = ~(\in2[31]  | \in1[31] );
  assign _05_ = \in2[30]  & \in1[30] ;
  assign _06_ = ~(\in2[30]  | \in1[30] );
  assign _07_ = ~(\in2[29]  & \in1[29] );
  assign _08_ = \in2[29]  | \in1[29] ;
  assign _09_ = ~(\in2[28]  & \in1[28] );
  assign _10_ = ~(\in2[28]  ^ \in1[28] );
  ...
  assign \res[32]  = _17_ | _03_;
  assign _18_ = ~(_04_ | _03_);
  assign \res[31]  = _18_ ^ _16_;
  assign _19_ = ~(_06_ | _05_);
  assign \res[30]  = _19_ ^ _14_;
  assign _20_ = ~(_08_ & _07_);
  assign \res[29]  = _20_ ^ _12_;
  assign _21_ = ~(\in2[25]  ^ \in1[25] );
  assign _22_ = ~\in1[24] ;
  assign _23_ = ~(_01_ | \in2[24] );
  assign _24_ = _23_ | _22_;
  assign _25_ = _01_ & \in2[24] ;
  assign _26_ = _24_ & ~(_25_);
  assign _27_ = _26_ | _21_;
  assign _28_ = _22_ & ~(_25_);
  assign _29_ = _28_ | _23_;
  assign _30_ = \in2[25]  ^ \in1[25] ;
  assign _31_ = _29_ & ~(_30_);
  assign \res[25]  = _27_ & ~(_31_);
  assign _32_ = ~(\in2[17]  ^ \in1[17] );
  assign _33_ = \in1[16]  & \in2[16] ;
  assign _34_ = \in2[17]  ^ \in1[17] ;
  assign \res[17]  = _33_ ? _32_ : _34_;
  assign _35_ = ~(\in1[15]  ^ \in2[15] );
  assign \res[15]  = _35_ ^ \res[12] ;
  assign \res[7]  = ~(\in1[7]  ^ \in2[7] );
  assign _36_ = \in1[3]  ^ \in2[3] ;
  assign _37_ = ~(\in1[0]  ^ \in2[0] );
  assign \res[3]  = _37_ ^ _36_;
  assign \res[28]  = ~(_10_ ^ _02_);
  assign \res[0]  = ~_37_;
  assign \res[10]  = 1'h0;
  assign \res[11]  = 1'h1;
  assign \res[13]  = 1'h1;
