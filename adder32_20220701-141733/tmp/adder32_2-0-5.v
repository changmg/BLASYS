...
, \res[20] , \res[21] , \res[22] , \res[23] , \res[24] , \res[25] , \res[26] , \res[27] , \res[28] , \res[29] , \res[30] , \res[31] , \res[32] );
  ...
  output \res[9] ;
  wire \res[9] ;
  assign _197_ = \in1[0]  & \in2[0] ;
  assign _198_ = \in2[1]  ^ \in1[1] ;
  assign _199_ = ~(\in2[1]  ^ \in1[1] );
  assign _200_ = _197_ ? _198_ : _199_;
  assign \res[1]  = ~_200_;
  assign _000_ = \in2[6]  ^ \in1[6] ;
  assign _001_ = ~\in1[3] ;
  assign _002_ = ~(_200_ | \in2[3] );
  assign _003_ = _002_ | _001_;
  assign _004_ = _200_ & \in2[3] ;
  ...
  assign _102_ = _101_ | _069_;
  assign _103_ = _068_ & ~(_102_);
  assign _104_ = _103_ | _067_;
  assign _105_ = ~(\in2[15]  | \in1[15] );
  assign _106_ = _104_ & ~(_105_);
  assign _107_ = _066_ & ~(_106_);
  assign _108_ = _065_ & ~(_107_);
  assign _109_ = _048_ | _046_;
  assign _110_ = _109_ | ~(_045_);
  assign _111_ = _108_ & ~(_110_);
  assign _112_ = ~(_060_ | _057_);
  assign _113_ = _061_ | ~(_034_);
  assign _114_ = _113_ | ~(_112_);
  assign _115_ = ~(_053_ & _035_);
  assign _116_ = _056_ | _036_;
  assign _117_ = _116_ | _115_;
  assign _118_ = _117_ | _114_;
  assign _119_ = _111_ & ~(_118_);
  assign _120_ = _119_ | _064_;
  ...
  assign _147_ = _146_ & ~(_030_);
  assign _148_ = _147_ | _029_;
  assign _149_ = _148_ & ~(_028_);
  assign \res[32]  = _149_ | _027_;
  assign _150_ = ~(_028_ | _027_);
  assign \res[31]  = _150_ ^ _148_;
  assign _151_ = ~(_030_ | _029_);
  assign \res[30]  = _151_ ^ _146_;
  assign _152_ = _031_ | ~(_032_);
  ...
  assign _158_ = _052_ & ~(_111_);
  assign _159_ = ~(_158_ | _115_);
  assign _160_ = _037_ & ~(_159_);
  assign _161_ = ~(_160_ | _056_);
  assign _162_ = ~(_161_ & _112_);
  assign _163_ = _162_ & ~(_060_);
  assign \res[23]  = _163_ ^ _113_;
  assign _164_ = _035_ & ~(_159_);
  assign \res[21]  = _164_ ^ _116_;
  assign _165_ = _049_ & ~(_108_);
  assign _166_ = ~(_165_ | _046_);
  assign _167_ = _166_ & _043_;
  assign _168_ = _039_ & ~(_167_);
  assign \res[19]  = _168_ ^ _044_;
  assign _169_ = _047_ & ~(_108_);
  assign \res[17]  = _169_ ^ _109_;
  assign _170_ = _066_ & ~(_105_);
  assign \res[15]  = _170_ ^ _104_;
  assign _171_ = _099_ | _069_;
  assign _172_ = _097_ & ~(_098_);
  assign \res[13]  = _172_ ^ _171_;
  assign _173_ = _091_ & ~(_076_);
  assign _174_ = ~(_173_ | _078_);
  assign _175_ = _174_ & _080_;
  assign _176_ = _087_ & ~(_175_);
  assign \res[11]  = _176_ ^ _083_;
  assign _177_ = ~(_076_ | _090_);
  assign \res[9]  = _177_ ^ _079_;
  assign _178_ = ~(_072_ | _071_);
  assign \res[7]  = _178_ ^ _026_;
  assign _179_ = ~(\in1[5]  ^ \in2[5] );
  assign _180_ = ~(_008_ | _005_);
  assign _181_ = _010_ & ~(_180_);
  assign _182_ = _181_ | _179_;
  assign _183_ = _010_ & ~(_017_);
  assign _184_ = ~(_013_ | _006_);
  assign _185_ = _183_ & ~(_184_);
  assign _186_ = _182_ & ~(_185_);
  assign _187_ = _008_ & ~(_184_);
  assign \res[5]  = _186_ & ~(_187_);
  assign _188_ = \in1[3]  ^ \in2[3] ;
  assign \res[3]  = _188_ ^ _200_;
  assign \res[24]  = ~(_121_ ^ _120_);
  assign \res[26]  = _154_ ^ _126_;
  assign _189_ = _008_ | ~(_010_);
  assign _190_ = _189_ & ~(_005_);
  assign _191_ = ~(\in1[4]  ^ \in2[4] );
  assign _192_ = ~(_191_ | _017_);
  assign \res[4]  = _192_ | _190_;
  assign \res[0]  = \in1[0]  ^ \in2[0] ;
  assign \res[12]  = ~(_096_ ^ _095_);
  assign \res[14]  = ~(_102_ ^ _068_);
  assign _193_ = ~(_071_ | _026_);
  assign _194_ = _073_ & ~(_193_);
  assign \res[8]  = _070_ ? _075_ : _194_;
  assign \res[10]  = _174_ ^ _080_;
  assign \res[20]  = _158_ ^ _115_;
  assign \res[22]  = _161_ ^ _112_;
  assign \res[18]  = _166_ ^ _043_;
  assign _195_ = _104_ | ~(_066_);
  assign _196_ = _195_ & ~(_105_);
  assign \res[16]  = _065_ ? _107_ : _196_;
