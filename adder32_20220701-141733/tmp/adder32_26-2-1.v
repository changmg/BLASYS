...
, \res[20] , \res[21] , \res[22] , \res[23] , \res[24] , \res[25] , \res[26] , \res[27] , \res[28] , \res[29] , \res[30] , \res[31] , \res[32] );
  ...
  assign _008_ = \res[20]  & ~(\in2[24] );
  assign _009_ = _008_ | _007_;
  assign _010_ = \in2[24]  & ~(\res[20] );
  ...
  assign _023_ = _012_ & ~(_020_);
  assign _024_ = _022_ & ~(_023_);
  assign \res[26]  = ~_024_;
  assign _025_ = \in2[31]  & \in1[31] ;
  assign _026_ = ~(\in2[31]  | \in1[31] );
  assign _027_ = \in2[30]  & \in1[30] ;
  assign _028_ = ~(\in2[30]  | \in1[30] );
  assign _029_ = \in2[29]  & \in1[29] ;
  ...
  assign \res[32]  = _039_ | _025_;
  assign _040_ = ~(_026_ | _025_);
  assign \res[31]  = _040_ ^ _038_;
  assign _041_ = ~(_028_ | _027_);
  assign \res[30]  = _041_ ^ _036_;
  assign _042_ = _029_ | ~(_030_);
  assign \res[29]  = _042_ ^ _034_;
  assign _043_ = ~(\in1[25]  ^ \in2[25] );
  assign _044_ = _043_ | _011_;
  assign _045_ = _012_ | ~(_014_);
  assign _046_ = _045_ & ~(_018_);
  assign \res[25]  = _044_ & ~(_046_);
  ...
  assign \res[3]  = _004_ ^ _000_;
  assign \res[28]  = _032_ ^ _024_;
  assign _005_ = ~(\in1[24]  ^ \in2[24] );
  assign \res[24]  = _005_ ^ \res[20] ;
  assign \res[1]  = ~_004_;
